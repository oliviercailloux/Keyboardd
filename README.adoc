...
This is an https://github.com/oliviercailloux/SVG-keyboard/blob/main/README.adoc[SVG keyboard]: the file contains the X key names of the corresponding keys.

https://github.com/oliviercailloux/Keyboardd/blob/main/src/test/java/io/github/oliviercailloux/keyboardd/thekey/TheKeyXKeyNamesTests.java#L22-L36[This code] uses the above SVG unlabeled file to produce a labeled keyboard (figure <<Labeled>>). Alternatively, https://github.com/oliviercailloux/Keyboardd/blob/main/src/test/java/io/github/oliviercailloux/keyboardd/thekey/TheKeyXKeyNamesTests.java#L39-L69[this code] produces a more appealing representation (figure <<Final>>).

.The Key as a labeled SVG keyboard
[[Labeled]]
image::file:///home/olivier/Local/Nextcloud%20LAMSADE/Professions/Enseignement/Java%20&%20HTML/Keyboardd/src/test/resources/io/github/oliviercailloux/keyboardd/thekey/The%20Key%20with%20X%20key%20names.svg[opts=inline]

.The Key, our final SVG keyboard
[[Final]]
image::file:///home/olivier/Local/Nextcloud%20LAMSADE/Professions/Enseignement/Java%20&%20HTML/Keyboardd/src/test/resources/io/github/oliviercailloux/keyboardd/thekey/The%20Key%20with%20chosen%20representations.svg[opts=inline]
...
`java -jar "$HOME/.vscode/extensions/jebbs.plantuml-2.18.1/plantuml.jar" -tsvg *.wsd`

== Representing UCPs
Maybe https://github.com/w3c/csswg-drafts/issues/8874[impossible] to achieve.

- https://graphicdesign.stackexchange.com/questions/57352/font-for-representing-unicode-non-printable-characters 
- https://packages.debian.org/bookworm/unifont 
- https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/font-family 
- https://unifoundry.com/unifont/ 
- https://stackoverflow.com/questions/13210729/make-spaces-tabs-newlines-visible-with-custom-font-instead-of-javascript 
- https://www.fileformat.info/info/unicode/char/2421/index.htm 
